    ...
    <div class="lg:grid lg:grid-cols-12 lg:gap-16 items-stretch">
        ...
        <div class="lg:col-span-5 flex flex-col h-full">
            ...
            <div class="rounded-3xl overflow-hidden shadow-xl mb-8 border-4 border-white bg-slate-200 relative aspect-[4/3] group flex-shrink-0">
                <img src="https://assets.cdn.filesafe.space/0EYrXwSAbw55Hpgu54CD/media/69c959ff3204cc19fd6be58f.png" alt="Robert Hill" class="w-full h-full object-cover object-top transition duration-700 group-hover:scale-105">
