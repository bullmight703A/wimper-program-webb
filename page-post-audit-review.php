    ...
    <div class="lg:col-span-2 h-full">
        <div class="bg-white rounded-3xl card-shadow border border-slate-100 overflow-hidden h-full flex flex-col">
            ...
            <div class="relative w-full aspect-video bg-slate-800 border-b-4 border-wimper-cyan flex-grow overflow-hidden group">
                ...
                <video id="mainVideoPlayer" src="https://assets.cdn.filesafe.space/0EYrXwSAbw55Hpgu54CD/media/69c9581bcd515935214a3095.mp4" playsinline controls preload="auto" class="absolute inset-0 w-full h-full object-contain z-0 bg-black"></video>
            </div>
        </div>
    </div>
