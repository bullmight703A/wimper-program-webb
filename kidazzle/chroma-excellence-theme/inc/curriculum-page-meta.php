...
function chroma_curriculum_page_meta_boxes()
{
	...
	add_meta_box(
		...
		__('Curriculum Framework (5 Pillars)', 'chroma-excellence'),
		...
		<tr>
			...
			<td>
				<input type="text" id="curriculum_hero_badge" name="curriculum_hero_badge"
					...
					placeholder="e.g., The Kidazzle Difference" />
			</td>
		</tr>
		<tr>
			...
			<td>
				<input type="text" id="curriculum_hero_title" name="curriculum_hero_title"
					...
					placeholder="e.g., Scientific rigor. Joyful delivery." />
				<p class="description">Use &lt;br&gt; for line breaks and &lt;span class='italic
					text-chroma-green'&gt;text&lt;/span&gt; for green italic text</p>
			</td>
		</tr>
		<tr>
			<th><label for="curriculum_hero_description">Description</label></th>
			<td>
				<textarea id="curriculum_hero_description" name="curriculum_hero_description" rows="4"
		...
		<tr>
			...
			<td>
				<input type="text" id="curriculum_framework_title" name="curriculum_framework_title"
					...
					placeholder="e.g., The Kidazzle Framework" />
			</td>
		</tr>
		<tr>
			<th><label for="curriculum_framework_description">Description</label></th>
			<td>
				<textarea id="curriculum_framework_description" name="curriculum_framework_description" rows="3"
			...
			<tr>
				...
				<td>
					<textarea id="curriculum_pillar_<?php echo esc_attr($pillar['name']); ?>_desc"
						name="curriculum_pillar_<?php echo esc_attr($pillar['name']); ?>_desc" rows="2"
		...
		<tr>
			...
			<td>
				<input type="text" id="curriculum_timeline_badge" name="curriculum_timeline_badge"
					value="<?php echo esc_attr($timeline_badge); ?>" placeholder="e.g., Learning Journey" />
			</td>
		</tr>
		<tr>
			...
			<td>
				<input type="text" id="curriculum_timeline_title" name="curriculum_timeline_title"
					...
					placeholder="e.g., How learning evolves." />
			</td>
		</tr>
		<tr>
			<th><label for="curriculum_timeline_description">Description</label></th>
			<td>
				<textarea id="curriculum_timeline_description" name="curriculum_timeline_description" rows="3"
		...
		<tr>
			...
			<td>
				<input type="text" id="curriculum_timeline_image" name="curriculum_timeline_image"
					value="<?php echo esc_attr($timeline_image); ?>" class="large-text chroma-image-field" />
				<button type="button" class="button chroma-upload-button" data-field="curriculum_timeline_image">Select
					Image</button>
				<button type="button" class="button chroma-clear-button"
					data-field="curriculum_timeline_image">Clear</button>
			</td>
		</tr>
			...
			<tr>
				...
				<td>
					<textarea id="curriculum_stage_<?php echo esc_attr($stage['name']); ?>_desc"
						name="curriculum_stage_<?php echo esc_attr($stage['name']); ?>_desc" rows="2"
						class="large-text"><?php echo esc_textarea($desc); ?></textarea>
				</td>
			</tr>
		<?php endforeach; ?>
		...
		<tr>
			...
			<td>
				<input type="text" id="curriculum_env_badge" name="curriculum_env_badge"
					value="<?php echo esc_attr($env_badge); ?>" placeholder="e.g., Environment" />
			</td>
		</tr>
		<tr>
			...
			<td>
				<input type="text" id="curriculum_env_title" name="curriculum_env_title"
					...
					placeholder="e.g., The classroom is the 'Third Teacher.'" />
			</td>
		</tr>
		<tr>
			<th><label for="curriculum_env_description">Description</label></th>
			<td>
				<textarea id="curriculum_env_description" name="curriculum_env_description" rows="4"
			...
			<tr>
				...
				<td>
					<input type="text" id="curriculum_zone_<?php echo esc_attr($zone['name']); ?>_emoji"
						...
						value="<?php echo esc_attr($emoji); ?>" placeholder="e.g., 🧱 or 🎨" style="width: 100px;" />
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<textarea id="curriculum_zone_<?php echo esc_attr($zone['name']); ?>_desc"
						name="curriculum_zone_<?php echo esc_attr($zone['name']); ?>_desc" rows="2"
						class="large-text"><?php echo esc_textarea($desc); ?></textarea>
				</td>
			</tr>
		<?php endforeach; ?>
		...
		<tr>
			...
			<td>
				<input type="text" id="curriculum_milestones_title" name="curriculum_milestones_title"
					...
					placeholder="e.g., Measuring Milestones" />
			</td>
		</tr>
		<tr>
			...
			<td>
				<input type="text" id="curriculum_milestones_subtitle" name="curriculum_milestones_subtitle"
					...
					placeholder="e.g., We don't just watch them grow..." />
			</td>
		</tr>
			...
			<tr>
				...
				<td>
					<textarea id="curriculum_milestone_<?php echo esc_attr($card['name']); ?>_desc"
						name="curriculum_milestone_<?php echo esc_attr($card['name']); ?>_desc" rows="3"
						class="large-text"><?php echo esc_textarea($desc); ?></textarea>
...
function chroma_curriculum_cta_meta_box_render($post)
{
	...
	<table class="form-table">
		...
		<tr>
			...
			<td>
				<textarea id="curriculum_cta_description" name="curriculum_cta_description" rows="2"
...
function chroma_seed_curriculum_page_defaults($post_id)
{
	...
	$defaults = array(
		...
		'curriculum_hero_description' => 'Our proprietary Kidazzle curriculum isn\'t just about ABCs. It\'s a comprehensive framework designed to build the critical thinking, emotional intelligence, and social skills needed for the 21st century.',

		'curriculum_framework_title' => 'The Kidazzle Framework',
		...
		'curriculum_cta_description' => 'Schedule a tour to see our "Third Teacher" classrooms and meet the educators bringing our curriculum to life.',
	);
