...
class wimper_Accessibility_SEO
{
    ...
    public function add_skip_nav() {
        if (!get_option('wimper_seo_enable_skip_nav', true)) {
            return;
        }
    ...
    public function add_accessibility_styles() {
        ...
        <style>
            ...
            /* Focus indicators */
            <?php if (get_option('wimper_seo_enable_focus_indicators', true)): ?>
            a:focus,
            button:focus,
            input:focus,
            select:focus,
