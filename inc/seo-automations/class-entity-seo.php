...
class wimper_Entity_SEO
{
    ...
    public function output_organization_schema() {
        ...
        $same_as = get_option('wimper_seo_same_as_urls', [
        ...
        $founder = get_option('wimper_seo_founder_name');
        if ($founder) {
            $schema['founder'] = [
                '@type' => 'Person',
                'name' => $founder
        ...
        // Add founding date
        $founded = get_option('wimper_seo_founded_date');
        if ($founded) {
