    ...
    <section class="py-24 text-white">
        <div class="max-w-7xl mx-auto px-4">
            <div class="grid lg:grid-cols-2 gap-20 items-center">
                <div>
                    <h2 class="text-4xl font-bold mb-8 text-white" style="font-family: 'Plus Jakarta Sans', sans-serif;">Stop Overpaying for "Standard" Benefits</h2>
                    <div class="space-y-6">
                        <div class="flex gap-4 text-white">
                            ...
                            <div>
                                <h4 class="text-xl font-bold mb-2" style="font-family: 'Plus Jakarta Sans', sans-serif;">Recapture Lost Cash Flow</h4>
                        ...
                        <div class="flex gap-4 text-white">
                            ...
                            <div>
                                <h4 class="text-xl font-bold mb-2" style="font-family: 'Plus Jakarta Sans', sans-serif;">Compete with Giants</h4>
                ...
                <div class="bg-white/5 p-8 rounded-3xl border border-white/10 backdrop-blur-sm">
                    <h3 class="text-2xl font-bold mb-6 text-white" style="font-family: 'Plus Jakarta Sans', sans-serif;">Request a Payout Report</h3>
                    <form class="space-y-4">
                        <div class="grid grid-cols-2 gap-4">
                            <input type="text" placeholder="First Name" class="bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500">
                            <input type="text" placeholder="Company Revenue" class="bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                        <input type="email" placeholder="Work Email" class="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <select class="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        <button class="w-full bg-blue-600 text-white font-bold py-4 rounded-xl hover:bg-blue-500 transition-all shadow-lg" onclick="navigateTo('contact'); return false;">
